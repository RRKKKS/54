...
keyboard.inline_keyboard = {
{
{text = 'اذهب لطلب جيزتك↙️', url = 't.me/rb_ro'},
},
}
local ban = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..ban.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
...
if Text and Text:match('(%d+)/happywheel') then
  ...
  local media = "https://t.me/B_R_R_1/2"
  local msg_media = {
  type = "video",
  media = media,
  caption = '',
...
{
{text = 'مطور الملف', url = 'http://t.me/r_n_b1'},
},
}
}
...
local Name = "*WُEُْLُCُOُMُْEْ  ُDADYVENOM\n┄──━━━ ● ━━━──┄\n*⚡ › [DADYVENOM](http://t.me/RB_RO)*\n\n*👤 › [𓆩  𝐷𝑒𝑣 𝑆𝑢𝑂𝑟𝐶𝑒 𓆪](https://t.me/RB_RO)*\n\n*🛒 › [MُْAُRُKُEُْT ُ](t.me/@B72_bot)*\n\n*📡 › [𝑇𝑤𝑆𝑜𝐿 𝐿𝑖𝑂𝑛](http://t.me/RB_RO)*\n┄──━━━ ● ━━━──┄*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' › إضغط هنا لتنصيب بوتك', url = 't.me/B72_bot?start'}
},
{
{text = 'اضف البوت الي مجموعتك✅', url = 't.me/'..UserBot..'?startgroup=new'}
},
...
if text == 'مطورين السورس' or text == 'المطورين الاساسين' or text == ' صحاب السورس' then
photo = "https://telegra.ph/file/81c34077a3d4e95db110e.jpg"
local Name = "*WُEُْLُCُOُMُْEْ  ُDADYVENOM\n┄──━━━ ● ━━━──┄\n*⚡ › [DADYVENOM](http://t.me/RB_RO)*\n\n*👤 › [𓆩  𝐷𝑒𝑣 𝑆𝑢𝑂𝑟𝐶𝑒 𓆪](https://t.me/RB_RO)*\n\n*🛒 › [MُْAُRُKُEُْT ُ](t.me/@B72_bot)*\n\n*📡 › [𝑇𝑤𝑆𝑜𝐿 VENOM](http://t.me/RB_RO)*\n┄──━━━ ● ━━━──┄*"
keyboard = {} 
keyboard.inline_keyboard = {
  {
    {text = ' ›  فينوم', url = 't.me/r_n_b1'}
    },

  {
{text = ' ›  رجب', url = 't.me/RG_AB'}
},
{
...
type = 'inline',
data = {
{{text = '𓌹 ↱ َِSOURCE VENOM ↲ 𓌺', url = 't.me/RB_RO'},},}}
